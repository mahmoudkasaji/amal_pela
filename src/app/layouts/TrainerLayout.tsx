...
import { LayoutDashboard, CalendarDays, Users, ClipboardList, User, LogOut, Flower2 } from 'lucide-react';

const navItems = [
  { to: '/trainer',            label: 'الرئيسية',  icon: LayoutDashboard, end: true },
  { to: '/trainer/schedule',   label: 'الجدول',    icon: CalendarDays },
  { to: '/trainer/trainees',   label: 'المتدربون', icon: Users },
  { to: '/trainer/attendance', label: 'الحضور',    icon: ClipboardList },
  { to: '/trainer/profile',    label: 'ملفي',      icon: User },
];
...
export default function TrainerLayout() {
  ...
  return (
    <div
      dir="rtl"
      style={{ fontFamily: "'Cairo', sans-serif", background: '#f7f8fa' }}
        ...
        <div className="px-5 pt-6 pb-5" style={{ borderBottom: '1px solid #f0f1f3' }}>
          <div className="flex items-center gap-2.5">
            ...
            <div>
              ...
              <p style={{ fontSize: '0.65rem', color: '#94a3b8', letterSpacing: '0.04em' }}>Trainer Space</p>
            </div>
          </div>
        </div>
        ...
        <div className="px-5 py-4" style={{ borderBottom: '1px solid #f0f1f3' }}>
          <div className="flex items-center gap-3">
            ...
            <div className="min-w-0">
              ...
              <p style={{ fontSize: '0.68rem', color: '#94a3b8' }}>مدربة</p>
            </div>
          </div>
        </div>
